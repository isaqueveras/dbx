...
```go
import "github.com/isaqueveras/dbx"
```


[![GoDoc](https://godoc.org/github.com/isaqueveras/dbx?status.png)](https://godoc.org/github.com/isaqueveras/dbx)
...
```go
import sq "github.com/isaqueveras/dbx"
...
* **How can I build an IN query on composite keys / tuples, e.g. `WHERE (col1, col2) IN ((1,2),(3,4))`? ([#104](https://github.com/isaqueveras/dbx/issues/104))**
...
* **Why doesn't `Eq{"mynumber": []uint8{1,2,3}}` turn into an `IN` query? ([#114](https://github.com/isaqueveras/dbx/issues/114))**
